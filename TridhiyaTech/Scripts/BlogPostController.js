angular.module('app.controllers').controller('BlogPostController', function ($scope, $sce, $location, $window, $http, configurationService, $state, $stateParams, $rootScope, localStorageService, $timeout, $filter) {
    ...
    if ($scope.parameter != "" && $scope.parameter != undefined) {
        ...
        if (!angular.isNumber(title)) {
            ...
            $scope.$root.title = 'Tridhya Tech Private Limited Blog | Company Portal Software Development | Company Portal Software Development Company USA';
            ...
            $scope.$root.metadescription = 'Tridhya Tech Private Limited present Software Development  Life cycle for business solutions. Our software development models included business intelligence software, retail erp software and healthcare software . We offer software development services in India,USA,UK and Australia.';
        }
    }
    else {
        // list page
