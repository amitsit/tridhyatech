...
.controller('SubscriptionController',
    function ($scope, $location, $window, $http, configurationService, $state, $rootScope, localStorageService, vcRecaptchaService) {
        $scope.$root.title = 'Tridhya Tech Private Limited Subscription for Updates | Ecommerce Portal Development Company USA | Ecommerce Portal Development Company UK';
